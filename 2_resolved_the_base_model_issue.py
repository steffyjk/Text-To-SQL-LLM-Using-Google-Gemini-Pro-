...
custom_prompt = [
    ...
    The SQL database has a table PERSON_DETAILS with the following columns: NAME, TECH, POSITION, YEARS_OF_EXPERIENCE.
    
    Example 1: How many entries of records are present?
    SQL: SELECT COUNT(*) FROM PERSON_DETAILS;
    
    Example 2: Tell me all the persons who are Software Engineers?
    SQL: SELECT * FROM PERSON_DETAILS WHERE POSITION="Software Engineer";
    
    The SQL code should not include backticks or the word 'sql' in the output.
    """
]
...
# Streamlit App
st.set_page_config(page_title="Gemini-Driven SQL Retrieval App")
st.header("Gemini-Driven App to Retrieve SQL Data")
